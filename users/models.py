...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    Attributes:
        ...
        email (models.EmailField): The email address of the user, used as the
            unique identifier.
        role (models.CharField): The role of the user, chosen from
            ROLE_CHOICES.
        ...
        website (models.URLField): A URL representing the user's or
        ...
        USERNAME_FIELD (str): The field used as the username for
